<template>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        <div class="d-flex flex-column flex-column-fluid">
            <div v-if="publishedBlogCount < 3" class="d-flex align-items-center gap-4 bg-myprimary-light p-6 px-lg-8">
                ...
                <div class="d-flex flex-column">
                    ...
                    <span class="text-myprimary fw-semibold fs-7">
                        Masukkan setidaknya 3 blog terbit agar tampilan di website muncul & terlihat lebih proporsional & sejajar.
                    </span>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const publishedBlogCount = computed(() => {
                return (props.blogs?.data || []).filter((blog) => blog.status === 'published').length;
            });
