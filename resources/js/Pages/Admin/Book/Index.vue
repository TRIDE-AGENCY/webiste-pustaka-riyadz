<template>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        <div class="d-flex flex-column flex-column-fluid">
            <div v-if="books.data.length < 3" class="d-flex align-items-center gap-4 bg-myprimary-light p-6 px-lg-8">
                ...
                <div class="d-flex flex-column">
                    ...
                    <span class="text-myprimary fw-semibold fs-7">
                        Masukkan setidaknya 3 buku agar tampilan di website muncul & terlihat lebih proporsional & sejajar.
                    </span>
                </div>
            </div>
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="bg-secondary min-w-175px" style="letter-spacing: 0.04em;">Detail</th>
                                            <th class="bg-secondary min-w-150px" style="letter-spacing: 0.04em;">Harga</th>
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr v-for="(book, index) in books.data" :key="book.id">
                                            ...
                                            <td class="d-flex align-items-center gap-4">
                                                <div class="ratio ratio-1x1 w-40px w-md-45px flex-shrink-0">
                                                    <img class="h-100 rounded-3 img-fluid object-fit-cover"
                                                        :src="book.cover ? `/storage/${book.cover}` : '/assets/media/illustrations/blog-placeholder.png'"
                                                        alt="Gambar Buku" />
                                                </div>
                                                <div>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span class="text-dark fw-bolder fs-5 mb-1">Tahun {{ book.year }}</span>
                                                    <span class="fs-7">{{ book.pages }} • {{ book.dimensions }} </span>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-dark text-truncate-1 fs-5 fw-bolder mb-1">
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span class="text-dark fw-bolder fs-5 mb-1">{{ formatDate(book.created_at) }}</span>
                                                    <span class="fs-7">{{ formatTime(book.created_at) }}</span>
                                                </div>
                                            </td>
        ...
        setup() {
            ...
            const formatPrice = (price) => {
                if (price === null || price === undefined || price === '') {
                    return 'Gratis / Tidak dicantumkan';
                }
