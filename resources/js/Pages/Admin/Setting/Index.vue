                            ...
                            <div class="row align-items-start m-0">
                                <div class="col-12 col-md-4 col-xl-3 p-0">
                                    ...
                                    >
                                        ...
                                        <p
                                            class="fs-5 d-none d-md-block text-gray-600 mt-3 mb-0 fw-normal"
                                        >
                            ...
                            <div class="row align-items-start m-0">
                                <div class="col-12 col-md-4 col-xl-3 p-0">
                                    <div class="card-header p-6 d-flex flex-column m-0 border-0" style="min-height: unset">
                                        ...
                                        <p class="fs-5 d-none d-md-block text-gray-600 mt-3 mb-0 fw-normal">
                                ...
                                <div class="col-12 col-md-8 col-xl-9 card-body p-6">
                                    <div class="mb-5 fv-row">
                                        <label class="required form-label fs-6">No. WhatsApp</label>
                                        <div class="input-group">
                                            <span class="input-group-text rounded-3 rounded-end-0" id="basic-addon2">+62</span>
                                            <input
                                                type="number"
                                                class="form-control fs-5 rounded-3 rounded-start-0"
                                                v-model="form.whatsapp"
                                                required
                                                placeholder="Masukkan nomor disini..."
                                                :class="{ 'is-invalid': errors.whatsapp }"
                                            />
                                        </div>
                                        <div v-if="errors.whatsapp" class="text-mydanger mt-2">
                                            {{ errors.whatsapp }}
                                        </div>
                                    </div>
                                    <div class="mb-5 fv-row">
                                ...
                                <div class="col-12 col-md-4 col-xl-3 p-0">
                                    ...
                                    >
                                        ...
                                        <p
                                            class="fs-5 d-none d-md-block text-gray-600 mt-3 mb-0 fw-normal"
                                        >
                                            Mengatur informasi SEO untuk halaman website
                                        </p>
                                    </div>
                                </div>
                                <div
