                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    <div class="dropdown">
                        <div class="symbol symbol-35px symbol-md-40px symbol-circle cursor-pointer" 
                                ...
                                aria-expanded="false"
                                title="Profil Akun">
                            <div class="symbol-label fw-bolder btn-myprimary-filled fs-5 border border-myprimary border-dashed">
                            ...
                            <li>
                                <div class="d-flex align-items-center mb-3 ms-1 py-2">
                                    ...
                                    <div class="d-flex flex-column" style="min-width: 0;">
                                        ...
                                        <span class="text-gray-600 fs-7 text-truncate w-100">{{ $page.props.auth.user.email }}</span>
                                    </div>
                                </div>
                            </li>
